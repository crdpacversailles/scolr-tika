...
class FolderOutStream extends java.io.OutputStream {
    ...
    public int Init(
            ...
            boolean testMode, String tempFileDirPath) throws java.io.IOException {
    ...
    int OpenFile() throws java.io.IOException {
        ...
        int ret = _extractCallback.GetStream(_ref2Offset + index, realOutStream2, askMode, tempFileDirPath);
